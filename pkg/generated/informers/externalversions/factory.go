...
import (
	...
	zbm "k8s.io/vk8scontroller/pkg/generated/informers/externalversions/zbm"
)
...
func (f *sharedInformerFactory) Ibm() zbm.Interface {
	return zbm.New(f, f.namespace, f.tweakListOptions)
}
